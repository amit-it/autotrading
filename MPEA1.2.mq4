...
extern string    FileName = "Trades-2018-08-30.CSV";
...
extern double MinOverallProfitPercent = 0.14; 
...
void OnTick() {
    ...
    {  
        ...
        takeprofit = NormalizeDouble(Bid*(100+modelPredictedDetails[3])/100,Digits);
        ...
        takeprofit = NormalizeDouble(Ask*(100+modelPredictedDetails[3])/100,Digits);
        if(modelPredictedDetails[1]==-1)
        {        
